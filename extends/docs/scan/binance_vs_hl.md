...
- Binance：8h（00/08/16 UTC）；样本 22 名字 2026-06 起 4434 期，**57–67% 期次 = 0**（死区），周末 78% 为 0；均值 9.8% APR（工作日）/ 4.8%（周末），|rate| 极值 0.52%/8h（未触 ±2% 上限）。**【勘误 08-18】韩股名字（SKHYNIX/SAMSUNG）实为 4h 一期（00/04/08/12/16/20 UTC），|rate| p99 22–31 bps、极值 50 bps/期；"8h"仅对美股名字成立（含 SKHY 美线）。见 `hl_kr_spread_mr.md` §5。**
